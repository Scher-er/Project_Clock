...
public interface ISqliteConnectionFactory
{
    ...
    /// <summary>Testa abertura da conexão e existência do schema.</summary>
...
public class SqliteConnectionFactory : ISqliteConnectionFactory
{
    ...
    public async Task<bool> TestarConexaoAsync(CancellationToken ct = default)
    {
        try
        {
            var conn = await ObterConexaoAsync();
            // Um SELECT simples confirma que o arquivo abriu e o schema existe
